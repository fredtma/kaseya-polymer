...
//============================================================================//
/* globals window, moment, Blob, console, document, setTimeout, angular, saveAs*/
(function () {
    "use strict";
    window.openFileSaveDialog = function (blob, filename, extension, data) {
        var now = moment().format('YYYY-MM-DD.HH.mm.ss');
        var fullFileName = date? filename + '-' + now + '.' + extension: filename +
        '.' + extension;
        if (!(blob instanceof Blob)) {
            console.error("data isn't a blob");
            return;
        }
        if (typeof safari !== 'undefined') {
            ...
            fileReader.onload = function () {
                ...
                alert('Your file should have now download but without an extension. Please rename it to have .' + extension + ' at the end. Alternatively you can export the file using Chrome or FireFox.');
            };
